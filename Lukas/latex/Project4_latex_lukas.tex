...
In our case, we want to study the phase transition from a ferromagnetic phase for low temperatures to a paramagnetic phase for high temperatures above the critical Temperature $T_c$(in a canonical ensemble this means a second order phase transition and therefore a divergence of the heat capacity at the critical Temperature).
...
&= \frac{1}{k_b T} \cdot \left( \frac{1}{Z} \cdot \left( 4^2 \cdot 1 \cdot e^{-8J\beta}+ 2^2 \cdot 4+(-2)^2 \cdot 4 + (-4)^2 \cdot 1 \cdot e^{-8J \beta } \right) - \left( \frac{2 \cdot e^{-8J\beta}+2}{3+ \mathrm{cosh}(8J\beta)} \right)^2 \right)\\
&= \frac{1}{k_b T} \cdot \left( \frac{32 e^{-8J\beta}+32}{ 12+ 4 \cdot \mathrm{cosh} \left( 8J \beta \right)}- \left( \frac{2 \cdot e^{-8J\beta}+2}{3+ \mathrm{cosh}(8J\beta)} \right)^2 \right)\\
&= \frac{1}{k_b T} \cdot \left(\frac{8 e^{-8J\beta}+8}{ 3+ \cdot \mathrm{cosh} \left( 8J \beta \right)}- \left( \frac{2 \cdot e^{-8J\beta}+2}{3+ \mathrm{cosh}(8J\beta)} \right)^2 \right)\\
&=\frac{1}{k_b T} \cdot \frac{16 (e^{8 J \beta}+1) (5 e^{8 \beta J}+e^{16 \beta J})}{(6 e^{8 \beta J}+e^{16 \beta J}+1)^2} 
\end{align}
